...
The synthetic test uses its own miniature local reference and explicitly sets `consortium_run: false`; GDC identity qualification is intentionally tested elsewhere.
